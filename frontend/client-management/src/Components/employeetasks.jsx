    ...
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gray-200 rounded-2xl p-6">
          <h1 className="text-blue-900 font-bold text-2xl mb-2">My Tasks</h1>
          <p className="text-gray-600 text-sm">View and manage all tasks assigned to you by the manager</p>
        </div>
        ...
        {/* Tasks List */}
        <div className="bg-gray-200 rounded-2xl p-6">
          <h2 className="text-blue-900 font-bold text-xl mb-4">All Tasks</h2>
