  ...
  const clients = [
    {
      ...
      email: 'aasthashrestha03@gmail.com',
      phone: '9806011000',
      role: 'Intern',
      department: 'UI/UX',
      status: 'Active'
    },
    {
      ...
      email: 'pritamshrestha@gmail.com',
      phone: '9806011001',
              ...
              <tbody className="divide-y divide-slate-200">
                {clients.map((client) => (
                  <tr key={client.id} className="hover:bg-slate-50 transition-colors">
                    <td className="px-6 py-4 text-sm text-slate-800">{client.name}</td>
                    <td className="px-6 py-4 text-sm text-slate-800">{client.email}</td>
                    <td className="px-6 py-4 text-sm text-slate-800">{client.phone}</td>
                    <td className="px-6 py-4 text-sm text-slate-800">{client.role}</td>
                    <td className="px-6 py-4 text-sm text-slate-800">{client.department}</td>
...
export default AdminClientContent