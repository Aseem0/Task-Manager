          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-blue-100 text-sm mb-4">
                ClientX is a task management system to help manage client tasks and projects efficiently.
              </p>
              <div className="flex space-x-3">
                <a href="#" className="w-8 h-8 bg-blue-500 rounded flex items-center justify-center hover:bg-blue-400">
                  <span className="text-sm">f</span>
                </a>
                <a href="#" className="w-8 h-8 bg-red-500 rounded flex items-center justify-center hover:bg-red-400">
                  <span className="text-sm">@</span>
                </a>
                <a href="#" className="w-8 h-8 bg-gray-800 rounded flex items-center justify-center hover:bg-gray-700">
                  <span className="text-sm">#</span>
                </a>
                <a href="#" className="w-8 h-8 bg-blue-700 rounded flex items-center justify-center hover:bg-blue-600">
